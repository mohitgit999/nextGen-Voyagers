...
const newScreen1 = `<section className="screen active" id="screen-1" data-screen="1" aria-labelledby="screen1-heading">
      ...
      <div className="locate-card symmetrical-card">
        <svg className="locate-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" style={{ margin: '0 auto 10px' }}>
          <circle cx="12" cy="12" r="7"/><path d="M12 2v3M12 19v3M2 12h3M19 12h3"/>
          <circle cx="12" cy="12" r="1.4" fill="currentColor" stroke="none"/>
        </svg>
        <h3>Share your location</h3>
...
// Strip out spaces just to find the index if exact matching fails, or simply use replace.
// Using a robust replace mechanism:
